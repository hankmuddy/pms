...
Ext.define('Ext.picker.Date', {
        ...
        me.keyNav = new Ext.util.KeyNav(me.eventEl, Ext.apply({
            ...
            left: function (e) {
                if (e.ctrlKey) {
                    ...
                    me.update(endDate.add(me.activeDate, day, -1));
                }
            },
            ...
            up: function (e) {
                if (e.ctrlKey) {
                    ...
                    me.update(endDate.add(me.activeDate, day, -7));
                }
            },
            ...
            home: function (e) {
                me.update(endDate.getFirstDateOfMonth(me.activeDate));
            },

            end: function (e) {
                me.update(endDate.getLastDateOfMonth(me.activeDate));
            }
        }, me.keyNavConfig));
    ...
    setValue: function (value) {
        this.value = Ext.Date.clearTime(value);
    ...
    fullUpdate: function (date) {
        var me = this,
            ...
            newDate = +endDate.clearTime(date),
            today = +endDate.clearTime(new Date()),
            min = me.minDate ? endDate.clearTime(me.minDate) : Number.NEGATIVE_INFINITY,
            max = me.maxDate ? endDate.clearTime(me.maxDate) : Number.POSITIVE_INFINITY,
            ddMatch = me.disabledDatesRE,
            ddText = me.disabledDatesText,
            ddays = me.disabledDays ? me.disabledDays.join('') : false,
            ddaysText = me.disabledDaysText,
            format = me.format,
            days = endDate.getDaysInMonth(date),
            firstOfMonth = endDate.getFirstDateOfMonth(date),
            startingPos = firstOfMonth.getDay() - me.startDay,
            previousMonth = endDate.add(date, endDate.MONTH, -1),
        ...
        days += startingPos;
        prevStart = endDate.getDaysInMonth(previousMonth) - startingPos;
        current = new Date(previousMonth.getFullYear(), previousMonth.getMonth(), prevStart, me.initHour);

        if (me.showToday) {
            tempDate = endDate.clearTime(new Date());
            disableToday = (tempDate < min || tempDate > max ||
                (ddMatch && format && ddMatch.test(endDate.dateFormat(tempDate, format))) ||
        ...
        setCellClass = function (cell, cls) {
            value = +endDate.clearTime(current);
            cell.title = endDate.format(current, longDayFormat);
            ...
            if (value < min) {
                ...
                formatValue = endDate.dateFormat(current, format);
