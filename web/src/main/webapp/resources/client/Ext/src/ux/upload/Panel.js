...
Ext.define('Ext.ux.upload.Panel', {
    ...
    config: {
        ...
        // strings
        textOk: l('uploadpanel.Ok'),
        textUpload: l('uploadpanel.Upload'),
        textBrowse: l('uploadpanel.Browse'),
        textAbort: l('uploadpanel.Abort'),
        textRemoveSelected: l('uploadpanel.RemoveSelected'),
        textRemoveAll: l('uploadpanel.RemoveAll'),

        // grid strings
        textFilename: l('uploadpanel.Filename'),
        textSize: l('uploadpanel.Size'),
        textType: l('uploadpanel.Type'),
        textStatus: l('uploadpanel.Status'),
        textProgress: '%',

        // status toolbar strings
        selectionMessageText: l('uploadpanel.Selected') + ' {0} ' + l('uploadpanel.file_s') + ', {1}',
        uploadMessageText: l('uploadpanel.UploadProgress') + ' {0}% ({1} ' + l('uploadpanel.of') + ' {2} ' + l('uploadpanel.ofFiles') + ')',

        // browse button
        buttonText: l('uploadpanel.Browse')
    },
