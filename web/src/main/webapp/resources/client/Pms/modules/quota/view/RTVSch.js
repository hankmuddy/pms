Ext.define('Pms.modules.quota.view.RTVSch', {
...
//            timeColumnWidth: 100,
        ...
        me.eventStore = Ext.create('Pms.modules.quota.store.RTVEvent', {startDate: me.startDate, endDate: me.endDate});
        me.resourceStore = Ext.create('Pms.modules.quota.store.RTVResource').load();
...
//            width            : ExampleDefaults.width,
            ...
            eventRenderer: function (event, resource, tplData, row, col, ds) {
                tplData.style = 'background-color:#E3CEF6;height:30px;';
                return {
                    headerText: '<div>' + event.get('roomsAvailable') + '</div>',
...
//                '<tpl if="moved && !movedFrom"><div class="chessboard-moved-right"></div></tpl>' +
            ...
            listeners: {
                eventdblclick: function (sch, rec, e, r) {
                    sch.up('rtvSch').fireEvent('openeditwindow', [rec]);
                },
        ...
        sch.ctx = new Ext.menu.Menu({
            items: [{
                    ...
                    handler: function (btn, e) {
                        sch.up('rtvSch').fireEvent('openeditwindow', rows);
                    }
                },{
...
//                handler: function (btn, e) {
//                    grid.up('RTVSch').fireEvent('commitplan', grid, rec, e);
//                }
//            }],
//            listeners: {
//                hide: function () {
