Ext.define('Pms.desktop.WindowManager', {
    extend: 'Ext.Component',

    requires: [
        "Ext.util.MixedCollection",
        "Pms.desktop.LoadingModule",
        'Pms.desktop.Window'
    ],
    ...
    activeWindowCls: 'pms-desktop-active-win',
    inactiveWindowCls: 'pms-desktop-inactive-win',

    initComponent: function () {
        this.windows = new Ext.util.MixedCollection();
        this.loader = Ext.create("Pms.desktop.LoadingModule", {
            hidden: true
        });
    ...
    /**
     * Creates the main window for an application.
     * If the application is configured as "singleton" this method return the same windows every time.
     * @param {Object} app The configuration object for the application
     * @return {Pms.desktop.Window} Return a window
     */
    createWindow: function (app) {
        var me = this,
            win,
            cfg = {
                // id: app.ident + 'module-window', // comment this line for default settings
                title: app.text,
                singleton: false
            };

//        if(app.hint) cfg.hint = app.hint;
        ...
        // uncomment the following lines for default settings:
        // if(cfg.singleton){
        ...
        // uncomment upper lines for default settings:

        win = Ext.create("Pms.desktop.Window", cfg);
    ...
    updateActiveWindow: function () {
        ...
        // prepends the active app window's title to the Pms
        // desktop window title, e.g.: [app title] - desktop title
    ...
    getActiveWindow: function () {
        ...
        if (zmgr) {
            // We cannot rely on activate/deActivate because that fires against non-Window
