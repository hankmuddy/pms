...
public class XmlRpcClient {
     ...
     */
    public Object callGeneric(String method, Object... params) throws XmlRpcException {
    ...
    public Object[] call(String method, Object... params) throws XmlRpcException {
        ...
        if (logger.isTraceEnabled()) {
            if (!"get_token".equals(method)) {
                logger.trace("Calling '{}' with params: {}", method, Arrays.toString(params));
            } else {
                logger.trace("Calling '{}' with params: {}", method, params[0]);
            }
        }
        return (Object[]) callGeneric(method, params);
    }
    ...
    private class Caller extends Thread {
        ...
        public Object call(String methodName, Object[] params) throws XmlRpcException {
            if (logger.isTraceEnabled()) {
                if (!"get_token".equals(methodName)) {
                    logger.trace("Calling '{}' with params: {}", methodName, Arrays.toString(params));
                } else {
                    logger.trace("Calling '{}' with params: {}", methodName, params[0]);
                }
            }
            try {
